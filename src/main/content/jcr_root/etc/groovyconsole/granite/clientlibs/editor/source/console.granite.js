var GroovyConsole = function () {
    ...
    return {
        initializeEditor: function () {
            var editorDiv = $('#granite_editor');
            window.editor = ace.edit('granite_editor');            
        ...
        loadScript: function (scriptPath, cb) {
            reset();

            $.get(CQ.shared.HTTP.getContextPath() + '/crx/server/crx.default/jcr%3aroot' + scriptPath + '/jcr%3Acontent/jcr:data').done(function (data) {
        ...
        saveScript: function (fileName, cb) {
            reset();

    ...
    <div id="enhancements" class="accordion-body collapse">
        <div class="accordion-inner">
            <ul>
                ...
                <li><a href="http://www.day.com/maven/jsr170/javadocs/jcr-2.0/javax/jcr/Binary.html">javax.jcr.Binary</a>
                    <ul>
                        <li>withBinary(Closure closure) - <span class="muted">Execute the closure and automatically dispose of the binary's resources when the closure completes.  The closure accepts a single argument with the current binary instance.</span></li>
                    </ul>
                </li>
            </ul>
        </div>

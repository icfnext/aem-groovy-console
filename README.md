...
1. [Download the console package](https://github.com/OlsonDigital/cq-groovy-console/releases/download/9.0.0/aem-groovy-console-9.0.0.zip).  For previous versions, tags can be checked out from GitHub and built directly from the source (e.g. `mvn install`).
